...
variables = [s3_path_SST, s3_path_SOLIN, s3_path_T, s3_path_Q, s3_path_U, s3_path_V, s3_path_PS, s3_path_TS, s3_path_SHFLX, s3_path_LHFLX, s3_path_PRECT]
...
logger.info("RUNNING: savwv_diagnostic_no_aod.py")
